  ...
  if(!post || !post.title === 'Failed to load post'){
    return(
      <main className="p-3 flex flex-col max-w-6xl mx-auto min-h-screen">
        <h2 className='text-3xl mt-10 p-3 text-center font-serif max-w-2xl mx-auto lg:text-4xl'>Post not found</h2>
      </main>
    );
  }
  return(
    <main className='p-3 flex flex-col max-w-6xl mx-auto min-h-screen'>
      ...
      <Link href={`/search?category=${post && post.category}`} className='self-center mt-5'>
